...
Run this to identify specific issues with tour templates and active/planned tours
"""
    ...
    try:
        ...
        if login_response.status_code == 200:
            ...
            if me_response.status_code == 200:
                ...
                print(f"✅ User permissions loaded: {len(permissions)} permissions")
...
def test_frontend_proxy():
    ...
    try:
        ...
        proxy_response = requests.get(f"{FRONTEND_URL}/api/v1/tour-templates/", timeout=10)
