...
class RoleService:
    ...
    async def get_permissions(self, skip: int = 0, limit: int = 100) -> List[PermissionResponse]:
    ...
    async def _assign_permissions(self, role_id: uuid.UUID, permission_ids: List[uuid.UUID]):
