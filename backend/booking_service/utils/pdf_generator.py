...
def generate_booking_voucher(booking: Booking, reservation_items: List = None) -> BytesIO:
    ...
    elements.append(Paragraph(f"Phone: {settings.company_phone} | Email: {settings.company_email}", normal_style))
    ...
    """.format(company_name=settings.company_name)
